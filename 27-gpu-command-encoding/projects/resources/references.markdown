##  Chapter 27: GPU Command Encoding Resources
...
> **Note**: The API has changed significantly. Argument buffers no longer need to be encoded, and residency sets exist now.
